		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into produk (namaproduk, gambar, deskripsi, rate, hargabefore, hargaafter)
			  values('$namaproduk','$pathdb','$deskripsi','$rate','$hargabefore','$hargaafter')";
...
<head>
    ...
    <title>Kelola Produk - Petshopqu</title>
