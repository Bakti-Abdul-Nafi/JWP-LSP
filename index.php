	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<!-- <p>DAPATKAN PENAWARAN MENARIK UNTUK HEWAN MU, BELANJA SEKARANG!</p> -->
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Petshopqu</a></h1>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Petshopqu, DKI Jakarta.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>info@email</li>
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i>How To</li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i>>FAQ</li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>Petshopqu. All rights reserved</p>
			</div>
		</div>
